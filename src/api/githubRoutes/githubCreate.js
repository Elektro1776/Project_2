...
router.post('/api/github/createFile', (req, res)=>{
  console.log('https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '/contents/' + req.body.path + '?access_token=' + req.body.github.token);
  request({
    headers: {
...
router.post('/api/github/createIssue', (req, res)=>{
  ...
  router.post('/api/github/createPullRequest', (req, res)=>{
    request({
      ...
      method: 'POST',
      json: true,
      url: 'https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '/pulls?access_token=' + req.body.github.token,
      body: {title: req.body.title,
      head: req.body.head,
      base: req.body.base,
      body: req.body.body}
  ...
  router.post('/api/github/createPullRequestComment', (req, res)=>{
    request({
      ...
      method: 'POST',
      json: true,
      url: 'https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '/pulls/' + req.body.number + '/comments?access_token=' + req.body.github.token,
  ...
  router.post('/api/github/createRepo', (req, res)=>{
    request({
      ...
      method: 'POST',
      json: true,
      url: 'https://api.github.com/user/repos?access_token=' + req.body.github.token,
  ...
  router.post('/api/github/addAssignees', (req, res)=>{
    request({
      ...
      method: 'POST',
      json: true,
      url: 'https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '/issues/' + req.body.number + '/assignees?access_token=' + req.body.github.token,
  ...
  router.post('/api/github/editComment', (req, res)=>{
    request({
      ...
      method: 'PATCH',
      json: true,
      url: 'https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '/issues/comments/' + req.body.id + '?access_token=' + req.body.github.token,
      body: {body: req.body.body}
    }, (err, response, body) => {
      console.log(' WHAT IS THE BODY?', body);
    })
  ...
  router.post('/api/github/fork', (req, res)=>{
    ...
    request({
      ...
      method: 'POST',
      json: true,
      url: 'https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '?access_token=' + req.body.github.token
    }, (err, response, body) => {
      console.log(' WHAT IS THE BODY?', body);
    })
  });
  ...
  router.post('/api/github/createIssueComment', (req, res)=>{
    request({
      ...
      method: 'POST',
      json: true,
      url: 'https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '/issues/' + req.body.number + '/comments?access_token=' + req.body.github.token,
      body: {body: req.body.body}
    }, (err, response, body) => {
      console.log(' WHAT IS THE BODY?', body);
    })
  ...
  router.post('/api/github/editIssue', (req, res)=>{
    request({
      ...
      method: 'PATCH',
      json: true,
      url: 'https://api.github.com/repos/' + req.body.owner + '/' + req.body.repo + '/issues/' + req.body.number + '?access_token=' + req.body.github.token,
      body: {title: req.body.title,
      body: req.body.body,
      assignees: req.body.assignees}
    }, (err, response, body) => {
